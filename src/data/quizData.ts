const quizData =
{
  "quizzes": [
    ...
    },
    {
      ...
      "questions": [
        { "questionText": "Which keyword declares a block-scoped variable?", "options": ["var", "let", "function", "static"], "correctAnswerIndex": 1, "difficulty": "Easy" },
        { "questionText": "What does const guarantee?", "options": ["Immutability of object", "No reassignment of the binding", "Deep freeze", "Compile-time constant"], "correctAnswerIndex": 1, "difficulty": "Easy" },
        { "questionText": "Which method creates a new array from mapping each element?", "options": ["forEach", "map", "reduce", "filter"], "correctAnswerIndex": 1, "difficulty": "Easy" },
        { "questionText": "What is the value of typeof null?", "options": ["null", "object", "undefined", "number"], "correctAnswerIndex": 1, "difficulty": "Moderate" },
        { "questionText": "Which syntax spreads array elements into a new array?", "options": ["...arr", "*arr", "&arr", "spread(arr)"], "correctAnswerIndex": 0, "difficulty": "Easy" },
        { "questionText": "Default parameter syntax is:", "options": ["function f(a=1){}", "function f(default a=1){}", "function f(a:=1){}", "function f(a==1){}"], "correctAnswerIndex": 0, "difficulty": "Easy" },
        { "questionText": "What does Array.prototype.reduce return when no initial value and empty array?", "options": ["0", "undefined", "TypeError", "null"], "correctAnswerIndex": 2, "difficulty": "Moderate" },
        { "questionText": "Which statement is true about arrow functions?", "options": ["They have their own this", "They don't have their own this", "They are constructors", "They hoist like function declarations"], "correctAnswerIndex": 1, "difficulty": "Moderate" },
        { "questionText": "Which string method returns an array by a separator?", "options": ["split", "slice", "substr", "trim"], "correctAnswerIndex": 0, "difficulty": "Easy" },
        { "questionText": "Promise.all rejects when:", "options": ["Any promise rejects", "All promises resolve", "First promise resolves", "After timeout"], "correctAnswerIndex": 0, "difficulty": "Moderate" }
      ]
    },
    {
      "topic": "TypeScript",
      "category": "Programming",
      "questions": [
        { "questionText": "Which is a TypeScript feature?", "options": ["Static typing", "JIT compilation", "Bytecode", "Native DOM"], "correctAnswerIndex": 0, "difficulty": "Easy" },
        { "questionText": "What does the 'any' type imply?", "options": ["Strict type", "No type checking", "Only number", "Only object"], "correctAnswerIndex": 1, "difficulty": "Easy" },
        { "questionText": "Which compiles TS to JS?", "options": ["tsc", "node", "babel-only", "npm"], "correctAnswerIndex": 0, "difficulty": "Easy" },
        { "questionText": "Which is correct interface syntax?", "options": ["interface A {}", "class interface A {}", "type interface A = {}", "declare A interface {}"], "correctAnswerIndex": 0, "difficulty": "Easy" },
        { "questionText": "What is 'unknown' vs 'any'?", "options": ["unknown is assignable to anything", "unknown requires type narrowing", "any is safer", "both identical"], "correctAnswerIndex": 1, "difficulty": "Moderate" },
        { "questionText": "Which enables strict null checks?", "options": ["strictNullChecks", "noImplicitAny", "noEmit", "skipLibCheck"], "correctAnswerIndex": 0, "difficulty": "Easy" },
        { "questionText": "How to define a generic function?", "options": ["function f<T>(x:T):T", "function<T> f(x):x", "generic f(x)", "template f<T>(x)"], "correctAnswerIndex": 0, "difficulty": "Moderate" },
        { "questionText": "Which narrows a union type?", "options": ["Type guards", "Enums", "Namespaces", "Triple equals off"], "correctAnswerIndex": 0, "difficulty": "Moderate" },
        { "questionText": "Which config file controls TS options?", "options": ["tsconfig.json", "typescript.json", "package.json", "babel.config"], "correctAnswerIndex": 0, "difficulty": "Easy" },
        { "questionText": "What does 'never' represent?", "options": ["Nullable", "No return/throws", "Unknown type", "Any type"], "correctAnswerIndex": 1, "difficulty": "Moderate" }
      ]
    },
    {
      "topic": "Java",
      "category": "Programming",
      "questions": [
        { "questionText": "Java is:", "options": ["Compiled to bytecode", "Interpreted to Python", "Purely compiled to native", "Only JIT"], "correctAnswerIndex": 0, "difficulty": "Easy" },
        { "questionText": "Which is not a primitive?", "options": ["int", "boolean", "String", "char"], "correctAnswerIndex": 2, "difficulty": "Easy" },
        { "questionText": "Which keyword prevents inheritance?", "options": ["final", "static", "sealed", "private"], "correctAnswerIndex": 0, "difficulty": "Easy" },
        { "questionText": "Which collection does not allow duplicates?", "options": ["List", "Set", "Queue", "ArrayList"], "correctAnswerIndex": 1, "difficulty": "Easy" },
        { "questionText": "Which handles exceptions?", "options": ["try-catch", "guard", "recover", "trap"], "correctAnswerIndex": 0, "difficulty": "Easy" },
        { "questionText": "StringBuilder is:", "options": ["Immutable", "Mutable", "Thread-safe", "A wrapper of char[] only"], "correctAnswerIndex": 1, "difficulty": "Moderate" },
        { "questionText": "Which method starts a thread?", "options": ["run()", "start()", "execute()", "begin()"], "correctAnswerIndex": 1, "difficulty": "Easy" },
        { "questionText": "Which package is default imported?", "options": ["java.lang", "java.util", "java.io", "java.net"], "correctAnswerIndex": 0, "difficulty": "Easy" },
        { "questionText": "Which feature supports multiple implementations?", "options": ["Polymorphism", "Encapsulation", "Abstraction", "Overloading only"], "correctAnswerIndex": 0, "difficulty": "Moderate" },
        { "questionText": "Which stream reads bytes?", "options": ["Reader", "InputStream", "Writer", "PrintWriter"], "correctAnswerIndex": 1, "difficulty": "Moderate" }
      ]
    },
    {
      "topic": "C/C++",
      "category": "Programming",
      "questions": [
        { "questionText": "Which header is for printf in C?", "options": ["stdio.h", "stdlib.h", "string.h", "math.h"], "correctAnswerIndex": 0, "difficulty": "Easy" },
        { "questionText": "Which is true about pointers?", "options": ["Store values only", "Store addresses", "Store types", "Store sizes"], "correctAnswerIndex": 1, "difficulty": "Easy" },
        { "questionText": "Which operator allocates memory in C++?", "options": ["malloc", "new", "calloc", "realloc"], "correctAnswerIndex": 1, "difficulty": "Easy" },
        { "questionText": "RAII stands for:", "options": ["Resource Acquisition Is Initialization", "Random Access Immediate Init", "Resource Access In Interface", "None"], "correctAnswerIndex": 0, "difficulty": "Moderate" },
        { "questionText": "Which is not a C storage class?", "options": ["auto", "register", "dynamic", "static"], "correctAnswerIndex": 2, "difficulty": "Moderate" },
        { "questionText": "Which supports function overloading?", "options": ["C", "C++", "Both", "Neither"], "correctAnswerIndex": 1, "difficulty": "Easy" },
        { "questionText": "Virtual functions enable:", "options": ["Compile-time polymorphism", "Run-time polymorphism", "No polymorphism", "Templates"], "correctAnswerIndex": 1, "difficulty": "Moderate" },
        { "questionText": "Which container maintains order and allows duplicates?", "options": ["std::set", "std::multiset", "std::unordered_set", "std::map"], "correctAnswerIndex": 1, "difficulty": "Moderate" },
        { "questionText": "Which specifier prevents inheritance in C++11+?", "options": ["final", "sealed", "override", "friend"], "correctAnswerIndex": 0, "difficulty": "Hard" },
        { "questionText": "Which is UB in C?", "options": ["Accessing out-of-bounds array", "Using printf", "Integer addition", "Pointer comparison within array"], "correctAnswerIndex": 0, "difficulty": "Hard" }
      ]
    },
    {
      "topic": "C#",
      "category": "Programming",
      "questions": [
        { "questionText": "C# primarily runs on:", "options": ["JVM", "CLR/.NET", "CPython", "V8"], "correctAnswerIndex": 1, "difficulty": "Easy" },
        { "questionText": "Which declares an auto-implemented property?", "options": ["public int X;", "public int X {get; set;}", "int X();", "var X => 0;"], "correctAnswerIndex": 1, "difficulty": "Easy" },
        { "questionText": "LINQ stands for:", "options": ["Language Integrated Query", "Linked Integrated Query", "Language Internal Query", "Linguistic Query"], "correctAnswerIndex": 0, "difficulty": "Easy" },
        { "questionText": "async methods typically return:", "options": ["void only", "Task/Task<T>", "Thread", "IEnumerable"], "correctAnswerIndex": 1, "difficulty": "Moderate" },
        { "questionText": "Which is value type?", "options": ["class", "record", "struct", "delegate"], "correctAnswerIndex": 2, "difficulty": "Easy" },
        { "questionText": "Which adds null-safety annotations?", "options": ["Nullable reference types", "Generics", "Tuples", "Dynamics"], "correctAnswerIndex": 0, "difficulty": "Moderate" },
        { "questionText": "Which pattern matches types and properties?", "options": ["Pattern matching", "Visitor", "Factory", "Proxy"], "correctAnswerIndex": 0, "difficulty": "Moderate" },
        { "questionText": "Entity Framework is:", "options": ["Logging lib", "ORM", "Web server", "Unit test lib"], "correctAnswerIndex": 1, "difficulty": "Easy" },
        { "questionText": "Which keyword prevents inheritance?", "options": ["sealed", "final", "static", "private"], "correctAnswerIndex": 0, "difficulty": "Easy" },
        { "questionText": "Which is not a valid access modifier?", "options": ["public", "internal", "protected", "friend"], "correctAnswerIndex": 3, "difficulty": "Easy" }
      ]
    },
    {
      ...
      "category": "Programming",
      "questions": [
        { "questionText": "Which is immutable?", "options": ["list", "tuple", "dict", "set"], "correctAnswerIndex": 1, "difficulty": "Easy" },
        { "questionText": "Which creates a set?", "options": ["{1,2,3}", "[1,2,3]", "(1,2,3)", "set[1,2,3]"], "correctAnswerIndex": 0, "difficulty": "Easy" },
        { "questionText": "Dictionary keys must be:", "options": ["Mutable", "Hashable", "Strings", "Numbers"], "correctAnswerIndex": 1, "difficulty": "Moderate" },
        { "questionText": "List comprehension syntax:", "options": ["[f(x) for x in xs]", "map(f,xs)", "{f(x) for x}", "(f(x) for x)"], "correctAnswerIndex": 0, "difficulty": "Easy" },
        { "questionText": "Which removes and returns last list item?", "options": ["remove", "discard", "pop", "shift"], "correctAnswerIndex": 2, "difficulty": "Easy" },
        { "questionText": "deque from collections is ideal for:", "options": ["O(1) append/pop ends", "Sorting", "Hashing", "Matrix ops"], "correctAnswerIndex": 0, "difficulty": "Moderate" },
        { "questionText": "Which ensures unique elements with fast membership?", "options": ["list", "tuple", "set", "deque"], "correctAnswerIndex": 2, "difficulty": "Easy" },
        { "questionText": "Which merges two dicts (Py3.9+)?", "options": ["a+b", "{**a, **b}", "a|b", "a.extend(b)"], "correctAnswerIndex": 2, "difficulty": "Moderate" },
        { "questionText": "Heapq implements:", "options": ["Binary heap", "Fibonacci heap", "BST", "AVL"], "correctAnswerIndex": 0, "difficulty": "Moderate" },
        { "questionText": "Which structure is best for LRU cache keys?", "options": ["list", "set", "OrderedDict", "array"], "correctAnswerIndex": 2, "difficulty": "Hard" }
      ]
    }
  ]
};
